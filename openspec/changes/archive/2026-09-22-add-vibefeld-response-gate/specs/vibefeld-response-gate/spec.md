...
MUST statements are normative, testable acceptance requirements. SHOULD
statements are implementation guidance and may be optimized only when they do
not conflict with a MUST. A SHOULD never permits bypassing a MUST.
