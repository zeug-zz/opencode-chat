# bundled-research-guidance Specification

## Purpose

Make the OpenCode Research research and report-writing guidance available from the packaged extension so users and the companion agent can use reviewed skills and command templates on demand without workspace copies or unnecessary prompt context.
