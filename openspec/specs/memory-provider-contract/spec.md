...
This capability defines a provider-neutral memory contract and safe no-provider fallback without exposing provider-specific configuration or enabling memory operations by itself.
