# session-tui-handoff Specification

## Purpose
Hand off an active chat session to an independent full OpenCode TUI via export/import while the companion chat server remains running; attach fallback if independent start fails.
