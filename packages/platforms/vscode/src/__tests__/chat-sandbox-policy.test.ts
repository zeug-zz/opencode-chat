...
describe("buildChatSandboxFilesystemPolicy", () => {
  ...
  it.each([
    "darwin",
    "linux",
  ] as const)("uses generic compatibility semantics for inherited plugin source and dependency reads on %s", (platform) => {
    const pluginSource =
      platform === "darwin" ? "/Users/tester/.local/share/plugins/research/index.js" : "/opt/plugins/research/index.js";
