...
![Demo](https://raw.githubusercontent.com/zeug-zz/opencode-chat/master/packages/platforms/vscode/media/demo.gif)
...
Contributions are welcome! See [CONTRIBUTING.md](https://github.com/zeug-zz/opencode-chat/blob/master/CONTRIBUTING.md) for details.

### License

[MIT](https://github.com/zeug-zz/opencode-chat/blob/master/LICENSE)
...
![デモ](https://raw.githubusercontent.com/zeug-zz/opencode-chat/master/packages/platforms/vscode/media/demo.gif)
...
このプロジェクトへの貢献を歓迎します。詳しくは [CONTRIBUTING.md](https://github.com/zeug-zz/opencode-chat/blob/master/CONTRIBUTING.md) を参照してください。
