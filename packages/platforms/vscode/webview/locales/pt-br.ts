...
export const ptBr: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "Estrutura verificada",
  "review.status.conditional": "Condicional",
  "review.status.unresolved": "Não resolvido",
  "review.status.refuted": "Refutado",
  "review.status.blocked": "Bloqueado",
  "review.status.auditFailed": "Auditoria falhou",
  "review.unavailableNote": "Esta resposta não foi revisada antes da entrega.",
  "review.conclusion": "Conclusão",
  "review.assumptions": "Suposições",
  "review.evidence": "Evidências",
  "review.evidence.notAssessed": "Não avaliada",
  "review.evidence.notRequired": "Não necessária",
  "review.evidence.sourceRecorded": "Fonte registrada",
  "review.evidence.unverified": "Não verificada",
  "review.evidence.humanVerified": "Verificada por uma pessoa",
  "review.evidence.conflicted": "Conflitante",
  "review.openChallenges": "Desafios abertos",
  "review.interpretiveBoundary": "Limite",
  "review.automaticLabel": "Revisão automática após a resposta",
  "review.automaticReason": "Motivo da seleção",
