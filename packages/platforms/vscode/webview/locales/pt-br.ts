...
export const ptBr: LocaleSchema = {
  ...
  // MCP setting
  "config.memoryRetention": "Retenção de memória",
  "config.memoryRetentionAutomatic": "Retenção automática de sessões",
  "config.memoryRetentionAutomaticEnabled": "Ativar retenção automática",
  "config.memoryRetentionAutomaticDescription":
    "Ativada por padrão para um provedor aprovado. Pode gravar resumos limitados de sessões na memória durável; desative-a neste workspace para impedir gravações automáticas.",
  "config.memoryRetentionAutomaticStatus": "Status automático",
  "config.memoryRetentionAutomaticActive": "Ativa",
  "config.memoryRetentionAutomaticDisabled": "Desativada",
  "config.memoryRetentionAutomaticUnavailable": "Indisponível (sem provedor aprovado)",
  "config.memoryRetentionAutomaticBlocked": "Bloqueada",
  "config.memoryRetentionAutomaticError": "Erro",
  "config.memoryRetentionExplicit": "Retenção explícita",
  "config.memoryRetentionEnabled": "Permitir retenção explícita",
  "config.memoryRetentionConfirmation": "Confirmação",
  "config.memoryRetentionDisabled": "A retenção está desativada",
  "config.memoryRetentionAwaitingConfirmation": "Disponível com confirmação a cada solicitação",
  "config.memoryRetentionAvailable": "Disponível",
  "config.memoryRetentionBlocked": "Bloqueada pela política do companheiro",
  "config.memoryRetentionUnavailable": "Indisponível",
  "config.memoryRetentionError": "Status indisponível",
  "config.memoryRetentionEvidenceWarning": "A memória recuperada é evidência, não instrução.",
  "config.yes": "Sim",
  "config.no": "Não",
  "config.required": "Obrigatória",
  "config.notRequired": "Não obrigatória",
  "config.mcp": "MCP",
