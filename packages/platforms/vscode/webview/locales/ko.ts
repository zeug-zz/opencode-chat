...
export const ko: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "구조 확인됨",
  "review.status.conditional": "조건부",
  "review.status.unresolved": "해결되지 않음",
  "review.status.refuted": "반박됨",
  "review.status.blocked": "차단됨",
  "review.status.auditFailed": "감사 실패",
  "review.unavailableNote": "이 응답은 전달 전에 검토되지 않았습니다.",
  "review.conclusion": "결론",
  "review.assumptions": "가정",
  "review.evidence": "증거",
  "review.evidence.notAssessed": "평가되지 않음",
  "review.evidence.notRequired": "필요하지 않음",
  "review.evidence.sourceRecorded": "출처 기록됨",
  "review.evidence.unverified": "검증되지 않음",
  "review.evidence.humanVerified": "사람이 검증함",
  "review.evidence.conflicted": "상충됨",
  "review.openChallenges": "미해결 과제",
  "review.interpretiveBoundary": "범위",
  "review.automaticLabel": "응답 후 자동 검토",
  "review.automaticReason": "선택 이유",
