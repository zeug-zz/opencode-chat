...
export const ja: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "構造を確認済み",
  "review.status.conditional": "条件付き",
  "review.status.unresolved": "未解決",
  "review.status.refuted": "反証済み",
  "review.status.blocked": "ブロック済み",
  "review.status.auditFailed": "監査失敗",
  "review.unavailableNote": "この回答は配信前にレビューされていません。",
  "review.conclusion": "結論",
  "review.assumptions": "前提",
  "review.evidence": "証拠",
  "review.evidence.notAssessed": "未評価",
  "review.evidence.notRequired": "不要",
  "review.evidence.sourceRecorded": "ソース記録済み",
  "review.evidence.unverified": "未検証",
  "review.evidence.humanVerified": "人手で検証済み",
  "review.evidence.conflicted": "矛盾あり",
  "review.openChallenges": "未解決の課題",
  "review.interpretiveBoundary": "境界",
  "review.automaticLabel": "応答後の自動レビュー",
  "review.automaticReason": "選択理由",
