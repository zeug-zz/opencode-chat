...
export const zhCn: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "结构已检查",
  "review.status.conditional": "有条件",
  "review.status.unresolved": "未解决",
  "review.status.refuted": "已驳斥",
  "review.status.blocked": "已阻止",
  "review.status.auditFailed": "审计失败",
  "review.unavailableNote": "此回答在交付前未经过审查。",
  "review.conclusion": "结论",
  "review.assumptions": "假设",
  "review.evidence": "证据",
  "review.evidence.notAssessed": "未评估",
  "review.evidence.notRequired": "不需要",
  "review.evidence.sourceRecorded": "已记录来源",
  "review.evidence.unverified": "未验证",
  "review.evidence.humanVerified": "人工验证",
  "review.evidence.conflicted": "存在冲突",
  "review.openChallenges": "未解决的挑战",
  "review.interpretiveBoundary": "边界",
  "review.automaticLabel": "响应后的自动审查",
  "review.automaticReason": "选择原因",
  "review.routingReason.evidenceDependent": "依赖证据的回答",
  "review.routingReason.multiStepArgument": "多步骤论证",
  "review.routingReason.highImpactRecommendation": "高影响建议",
  "review.feedback.label": "反馈",
  "review.feedback.correct": "正确",
  "review.feedback.unfoundedChallenge": "无依据的质疑",
  "review.feedback.recorded": "反馈已记录",
