...
export const es: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "Estructura comprobada",
  "review.status.conditional": "Condicional",
  "review.status.unresolved": "Sin resolver",
  "review.status.refuted": "Refutado",
  "review.status.blocked": "Bloqueado",
  "review.status.auditFailed": "Auditoría fallida",
  "review.unavailableNote": "Esta respuesta no se revisó antes de entregarse.",
  "review.conclusion": "Conclusión",
  "review.assumptions": "Supuestos",
  "review.evidence": "Evidencia",
  "review.evidence.notAssessed": "No evaluada",
  "review.evidence.notRequired": "No necesaria",
  "review.evidence.sourceRecorded": "Fuente registrada",
  "review.evidence.unverified": "No verificada",
  "review.evidence.humanVerified": "Verificada por una persona",
  "review.evidence.conflicted": "En conflicto",
  "review.openChallenges": "Desafíos abiertos",
  "review.interpretiveBoundary": "Límite",
  "review.automaticLabel": "Revisión automática posterior a la respuesta",
  "review.automaticReason": "Motivo de selección",
  ...
  "config.notRequired": "No obligatoria",
  "config.mcp": "MCP",
  "config.mcpEmpty":
  ...
  "config.thinking": "Pensamiento",
  "config.showAllThinking": "Mostrar todo el pensamiento",
