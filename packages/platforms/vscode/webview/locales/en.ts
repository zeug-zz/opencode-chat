export const en = {
  ...
  // MCP setting
  "config.memoryRetention": "Memory retention",
  "config.memoryRetentionAutomatic": "Automatic session retention",
  "config.memoryRetentionAutomaticEnabled": "Enable automatic retention",
  "config.memoryRetentionAutomaticDescription":
    "Enabled by default for an approved provider. This may write bounded session summaries to durable memory; disable it for this workspace to prevent automatic writes.",
  "config.memoryRetentionAutomaticStatus": "Automatic status",
  "config.memoryRetentionAutomaticActive": "Active",
  "config.memoryRetentionAutomaticDisabled": "Disabled",
  "config.memoryRetentionAutomaticUnavailable": "Unavailable (no approved provider)",
  "config.memoryRetentionAutomaticBlocked": "Blocked",
  "config.memoryRetentionAutomaticError": "Error",
  "config.memoryRetentionExplicit": "Explicit retention",
  "config.memoryRetentionEnabled": "Allow explicit retention",
  "config.memoryRetentionConfirmation": "Confirmation",
  "config.memoryRetentionDisabled": "Retention is disabled",
  "config.memoryRetentionAwaitingConfirmation": "Available with confirmation for each request",
  "config.memoryRetentionAvailable": "Available",
  "config.memoryRetentionBlocked": "Blocked by companion policy",
  "config.memoryRetentionUnavailable": "Unavailable",
  "config.memoryRetentionError": "Status unavailable",
  "config.memoryRetentionEvidenceWarning": "Retrieved memory is evidence, not instructions.",
  "config.yes": "Yes",
  "config.no": "No",
  "config.required": "Required",
  "config.notRequired": "Not required",
  "config.mcp": "MCP",
