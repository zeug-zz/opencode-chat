...
export const ru: LocaleSchema = {
  ...
  // MCP setting
  "config.memoryRetention": "Сохранение памяти",
  "config.memoryRetentionAutomatic": "Автоматическое сохранение сеансов",
  "config.memoryRetentionAutomaticEnabled": "Включить автоматическое сохранение",
  "config.memoryRetentionAutomaticDescription":
    "По умолчанию включено для одобренного провайдера. Может записывать ограниченные сводки сеансов в долговременную память; отключите для этого рабочего пространства, чтобы запретить автоматические записи.",
  "config.memoryRetentionAutomaticStatus": "Автоматический статус",
  "config.memoryRetentionAutomaticActive": "Активно",
  "config.memoryRetentionAutomaticDisabled": "Отключено",
  "config.memoryRetentionAutomaticUnavailable": "Недоступно (нет одобренного провайдера)",
  "config.memoryRetentionAutomaticBlocked": "Заблокировано",
  "config.memoryRetentionAutomaticError": "Ошибка",
  "config.memoryRetentionExplicit": "Явное сохранение",
  "config.memoryRetentionEnabled": "Разрешить явное сохранение",
  "config.memoryRetentionConfirmation": "Подтверждение",
  "config.memoryRetentionDisabled": "Сохранение отключено",
  "config.memoryRetentionAwaitingConfirmation": "Доступно с подтверждением каждого запроса",
  "config.memoryRetentionAvailable": "Доступно",
  "config.memoryRetentionBlocked": "Заблокировано политикой компаньона",
  "config.memoryRetentionUnavailable": "Недоступно",
  "config.memoryRetentionError": "Статус недоступен",
  "config.memoryRetentionEvidenceWarning": "Полученная память — это свидетельства, а не инструкции.",
  "config.yes": "Да",
  "config.no": "Нет",
  "config.required": "Требуется",
  "config.notRequired": "Не требуется",
  "config.mcp": "MCP",
  ...
  "input.type.skill": "Навык",
  "input.type.command": "Команда",
};
