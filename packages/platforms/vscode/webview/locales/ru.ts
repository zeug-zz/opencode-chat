...
export const ru: LocaleSchema = {
  ...
  "review.status.structurallyChecked": "Структура проверена",
  "review.status.conditional": "Условно",
  "review.status.unresolved": "Не решено",
  "review.status.refuted": "Опровергнуто",
  "review.status.blocked": "Заблокировано",
  "review.status.auditFailed": "Аудит не пройден",
  "review.unavailableNote": "Этот ответ не проверялся до отправки.",
  "review.conclusion": "Вывод",
  "review.assumptions": "Допущения",
  "review.evidence": "Доказательства",
  "review.evidence.notAssessed": "Не оценено",
  "review.evidence.notRequired": "Не требуется",
  "review.evidence.sourceRecorded": "Источник записан",
  "review.evidence.unverified": "Не проверено",
  "review.evidence.humanVerified": "Проверено человеком",
  "review.evidence.conflicted": "Противоречиво",
  "review.openChallenges": "Открытые вопросы",
  "review.interpretiveBoundary": "Граница",
  "review.automaticLabel": "Автоматическая проверка после ответа",
  "review.automaticReason": "Причина выбора",
